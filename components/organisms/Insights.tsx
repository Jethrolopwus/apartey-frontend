...
const MetricCard: React.FC<MetricCardProps> = ({ title, value, change, isPositive, subtitle }) => (
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-6">Find your perfect rental with confidence</p>
          <div className="flex justify-center gap-4">
            <button 
              className="px-6 py-3 bg-[#C85212] text-white font-medium rounded-lg hover:bg-[#B8460F] transition-colors"
            >
              View Latest Market Report
            </button>
            <button 
              className="px-6 py-3 border border-[#C85212] text-[#C85212] font-medium rounded-lg hover:bg-orange-50 transition-colors"
            >
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Average Property Price Trends</h3>
              <div className="h-64">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Property Types Distribution</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Top Locations by Listings</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={locationData} layout="horizontal">
                  <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
                  <XAxis type="number" hide />
                  <YAxis type="category" dataKey="location" axisLine={false} tickLine={false} />
                  <Bar dataKey="listings" fill="#C85212" radius={[0, 4, 4, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Customer Reviews Growth</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">

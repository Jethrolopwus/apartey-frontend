...
const PriceForm = ({ formData, setFormData, onNext, onBack }: PriceFormProps) => {
  // React Hook Form setup for price validation
  const {
    register,
    handleSubmit,
  ...
  // Update localData when form values change
  useEffect(() => {
    setLocalData(prev => ({
      ...prev,
      price: watchedPrice,
  ...
  const onSubmit = (data: PriceFormData) => {
    // Update the form data before proceeding
    setLocalData(prev => ({
      ...prev,
      price: data.price,
    ...
    <div className="w-full space-y-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex items-center border border-gray-300 rounded-md focus-within:ring-2 focus-within:ring-orange-500">
                ...
                <input
                  {...register('price', { 
                    ...
                    pattern: { 
                      value: /^[0-9,]+$/, 
                      message: 'Please enter a valid price (numbers and commas only)' 
                    },
                    minLength: { value: 1, message: 'Price cannot be empty' }
                  })}
                  type="text"
                  name="price"
          ...
          <div>
            ...
            <div className="mt-1 flex gap-2 w-full max-w-sm">
              ...
              <input
                ...
                name="price"
                id="price"
                className={`block w-full rounded-md border focus:border-gray-500 focus:ring-gray-500 text-base py-2 px-4 outline-none ${
        ...
        <div className="space-y-4">
          ...
          {errors.offerType && (
            <p className="mt-2 text-sm text-red-600">{errors.offerType.message}</p>
          )}
        </div>
